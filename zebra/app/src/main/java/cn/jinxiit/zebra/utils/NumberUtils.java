...
public class NumberUtils
{
    ...
    */
    ...
    //浮点去掉 ".00"
    @NonNull
    public static String floatQu0(float f)
    {
        @SuppressLint("DefaultLocale") String strData = String.format("%.2f", f);
        String substr = strData.substring(strData.length() - 3);
        if (".00".equals(substr))
        {
